...
internal protocol Flow_Execution_ExecutionAPIClientProtocol: GRPCClient {
...
extension Flow_Execution_ExecutionAPIClientProtocol {
  ...
  ///   - callOptions: Call options.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  internal func getAccountAtBlockID(
    _ request: Flow_Execution_GetAccountAtBlockIDRequest,
    callOptions: CallOptions? = nil
  ) -> UnaryCall<Flow_Execution_GetAccountAtBlockIDRequest, Flow_Execution_GetAccountAtBlockIDResponse> {
    return self.makeUnaryCall(
...
internal protocol Flow_Execution_ExecutionAPIClientInterceptorFactoryProtocol {
...
internal final class Flow_Execution_ExecutionAPIClient: Flow_Execution_ExecutionAPIClientProtocol {
...
extension Flow_Execution_ExecutionAPIProvider {
  internal var serviceName: Substring { return "flow.execution.ExecutionAPI" }
